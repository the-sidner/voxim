...
const EXPECTED: Record<string, Snapshot> = {
  fm_a: {
    ...
    rooms:       "8348d93f98fa77c5",
    chambers:    "ea6e43af79826d9c",
    corridors:   "0a73de8fdcf3b0c0",
    portals:     "697ce1fe31fdc982",
  ...
  fm_b: {
    ...
    rooms:       "206ae822aab76ca0",
    chambers:    "44f429cc3bcad7ab",
    corridors:   "20f7aa84b4c1a948",
    portals:     "fee15272a011f9a5",
  ...
  op: {
    ...
    rooms:       "bf601016191675ff",
    chambers:    "ffdf64b4b5bd77eb",
    corridors:   "7216e46f4c06d0a4",
    portals:     "f16b9cbd5fdf880a",
  ...
  cd: {
    ...
    rooms:       "8ac49255571009f0",
    chambers:    "4cba8d738efe6bcc",
    corridors:   "348b894aee2889be",
    portals:     "9c1c728ecb217def",
