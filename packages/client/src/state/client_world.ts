...
import {
  ...
  staminaCodec, modelRefCodec, animationStateCodec, equipmentCodec,
} from "@voxim/codecs";
import type { HeightmapData, MaterialGridData, ModelRefData, AnimationStateData, EquipmentData } from "@voxim/codecs";
