...
// Type-aware composition. Overloads go up to 13 stages — the current atlas
// tilemap pipeline has 13 (T-311 P6 added `cliff`). Extend if more stages
// stack up. Each successive overload chains TOut of stage N into TIn of
// stage N+1; mismatches are compile errors at the pipe() call site.
