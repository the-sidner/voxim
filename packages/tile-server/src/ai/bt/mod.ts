...
import { checkSleepCriticalFactory } from "./nodes/check_sleep_critical.ts";
...
import { setJobSeekBedFactory } from "./nodes/set_job_seek_bed.ts";
...
export function registerBuiltinBTNodes(registry: Registry<BTNodeFactory>): void {
  ...
  registry.register(checkSleepCriticalFactory);
  ...
  registry.register(setJobSeekBedFactory);
