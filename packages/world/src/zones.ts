...
export const ZONE_PROFILES: Record<ZoneType, ZoneSpawnProfile> = {
  ...
  [ZoneType.Plains]: {
    ...
    npcWeights: { villager: 6, bandit: 2, archer: 1 },
    entityWeights: { tree: 4, stone_deposit: 2, bush: 5, flower_patch: 4, rock_small: 2, berry_bush: 3, clay_deposit: 2, flint_deposit: 1 },
  ...
  [ZoneType.Forest]: {
    ...
    entityWeights: { tree: 10, stone_deposit: 1, iron_ore_vein: 1, bush: 4, pine_tree: 6, rock_small: 1, mushroom_patch: 4, berry_bush: 2 },
    propWeights: { model_dead_tree: 2 },
  },
  [ZoneType.Hills]: {
    dangerLevel: 4,
    corruptionBaseline: 15,
    npcWeights: { bandit: 6, wolf: 3, archer: 2 },
    entityWeights: { stone_deposit: 8, iron_ore_vein: 3, tree: 2, rock_small: 4, rock_large: 3, bush: 2, coal_seam: 3, copper_ore_vein: 2, flint_deposit: 2 },
    propWeights: { model_dead_tree: 2 },
  },
  [ZoneType.Mountains]: {
    dangerLevel: 7,
    ...
    npcWeights: { bandit: 4 },
    entityWeights: { stone_deposit: 10, iron_ore_vein: 8, rock_large: 6, pine_tree: 2, coal_seam: 5, copper_ore_vein: 4, flint_deposit: 3 },
  ...
  [ZoneType.Swamp]: {
    ...
    npcWeights: { wolf: 5 },
    entityWeights: { tree: 3, bush: 4, mushroom_patch: 6 },
  ...
  [ZoneType.Tundra]: {
    ...
    npcWeights: { wolf: 6 },
    entityWeights: { stone_deposit: 5, iron_ore_vein: 2, pine_tree: 4, rock_small: 3, coal_seam: 2, flint_deposit: 2 },
    propWeights: { model_dead_tree: 3 },
  },
  [ZoneType.Desert]: {
    dangerLevel: 4,
    corruptionBaseline: 15,
    npcWeights: { bandit: 8, merchant: 2, archer: 3 },
    entityWeights: { stone_deposit: 4, rock_large: 2, flint_deposit: 4 },
    propWeights: { model_building_ruin_wall: 3, model_building_ruin_tower: 2 },
  },
  [ZoneType.Ruins]: {
    dangerLevel: 8,
    corruptionBaseline: 85,
    npcWeights: { bandit: 10, archer: 5 },
    entityWeights: { iron_ore_vein: 5, coal_seam: 2 },
  ...
  [ZoneType.Shore]: {
    ...
    entityWeights: { tree: 2, flower_patch: 3, bush: 2, clay_deposit: 4 },
    propWeights: {},
  },
  [ZoneType.Water]: {
    dangerLevel: 2,
